...
def XOR_operation(tem,test):
    ...
    defect=cv2.medianBlur(defect,7)
    ...
    for(index,contour) in  enumerate(contours):
     ...
     if(np.sum(Map[y-64:y+64,x-64:x+64,:])==0):
          filemame="C:\\Users\\User\\Desktop\\PCB_DATASET\\Defect_data\\open_circuit\\"+str(def_num)+".jpg"
          try:
...
test_path="C:\\Users\\User\\Desktop\\PCB_DATASET\\images\\Open_circuit"
